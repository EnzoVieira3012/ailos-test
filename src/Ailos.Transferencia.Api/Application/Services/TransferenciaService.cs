...
public sealed class TransferenciaService : ITransferenciaService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!string.IsNullOrEmpty(resultadoAnterior))
        {
            ...
            // CORREÇÃO: Usar EncryptedId do namespace Ailos.EncryptedId
    ...
    private TransferenciaResponse CriarResponse(
        ...
        long contaDestinoId)
    {
        // CORREÇÃO: Não precisamos do using, apenas usar o serviço
        return new TransferenciaResponse
        {
    ...
    {
        var errorType = ex is DomainException domainEx ? domainEx.ErrorType : "INTERNAL_ERROR";
